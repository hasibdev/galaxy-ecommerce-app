   ...
   <app-layout :footer="false">
      ...
      <div class="q-mt-md">
         <form @submit.prevent="formSubmit" class="q-mt-lg">
            ...
            <q-btn rounded outline no-caps href="https://www.galaxytelecom.fr/api/login/facebook" size="lg" color="grey" class="full-width">
               <facebook-svg />
               <span class="q-ml-md">Continue With FB</span>
            </q-btn>
            <q-btn rounded outline no-caps href="https://www.galaxytelecom.fr/api/login/google" size="lg" color="grey" class="full-width q-mt-md">
               <google-svg />
